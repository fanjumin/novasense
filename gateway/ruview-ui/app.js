...
import { installTextBridge } from './utils/i18n-zh-bridge.js';
...
class WiFiDensePoseApp {
  ...
  async initializeServices() {
    ...
    if (useMock) {
      ...
      try {
        ...
        this.showBackendStatus(i18n.t('app.connectedRust'), 'success');
      } catch (error) {
  ...
  initializeEnhancements() {
    ...
    // Internationalization (EN/PL/zh) + runtime zh bridge for JS-rendered content
    i18n.init();
    installTextBridge();
