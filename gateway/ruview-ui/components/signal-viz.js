...
export class SignalVisualization {
  ...
  _buildLabels() {
    ...
    const labels = [
      { text: i18n.t('viz.csiAmplitude'), pos: [0, 5.2, 0], parent: this._heatmapGroup },
      { text: i18n.t('viz.phase'), pos: [0, 0.7, 0], parent: this._phaseGroup },
      { text: i18n.t('viz.dopplerSpectrum'), pos: [0, 0.8, 0], parent: this._dopplerGroup },
      { text: i18n.t('viz.motion'), pos: [0, 0.55, 0], parent: this._motionGroup }
    ];
