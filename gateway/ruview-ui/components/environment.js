...
export class Environment {
  constructor(scene) {
    ...
    // Detection zones
    this.zones = [
      { id: 'zone_1', center: [-2, 0, 0], radius: 2, color: 0x0066ff, label: i18n.t('viz.zone1') },
      { id: 'zone_2', center: [0, 0, 0], radius: 2, color: 0x00cc66, label: i18n.t('viz.zone2') },
      { id: 'zone_3', center: [2, 0, 0], radius: 2, color: 0xff6600, label: i18n.t('viz.zone3') }
    ];
